@extends('layout')
@section('title', 'Маникюрный салон, Казань, красивый маникюр')
@section('content')
{{--<!-- banner -->--}}
                ...
                <div class="container-fluid">
                    <div class="carousel-caption relative">
                        <div class="row d_flex">
                            <div class="col-md-6">
                                <img class="bann_img" src="public/images/nail_face2.jpg" alt="#"/>
                            </div>
                            <div class="col-md-6">
                                <span>01/03</span>
            ...
            <div class="carousel-item">
                <div class="container-fluid">
                    <div class="carousel-caption relative">
                        <div class="row d_flex">
                            <div class="col-md-6">
                                <img class="bann_img" src="public/images/nail_face.jpg" alt="#"/>
                            </div>
                            <div class="col-md-6">
                                <span>02/03</span>
                                <h1>Milina nail Salon Creating Beauty</h1>
            ...
            <div class="carousel-item">
                <div class="container-fluid">
                    <div class="carousel-caption relative">
                        <div class="row d_flex">
                            <div class="col-md-6">
                                <img class="bann_img" src="public/images/banner_ing.jpg" alt="#"/>
                            </div>
                            <div class="col-md-6">
                                <span>03/03</span>
                                <h1>Milina nail Salon Creating Beauty</h1>
            ...
            <div class="col-lg-10 offset-lg-1 col-md-12">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="we_box">
                            <i><img src="public/images/weicon1.png" alt="#"/></i>
                            <h3>Nail Art</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="we_box">
                            <i><img src="public/images/weicon2.png" alt="#"/></i>
                            <h3>Manicure</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur </p>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="we_box">
                            <i><img src="public/images/weicon3.png" alt="#"/></i>
                            <h3>Pedicure</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur </p>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="we_box">
                            <i><img src="public/images/weicon4.png" alt="#"/></i>
                            <h3>Paraffin wax</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur </p>
                        </div>
                    </div>
            ...
            <div class="col-lg-8 offset-lg-2 col-md-12">
                <div class="row">
                    <div class="col-md-4">
                        <div id="exp" class="experts_box">
                            <div class="experts_img">
                                <figure><img src="public/images/blog1.jpg" alt="#"/></figure>
                            </div>
                            <div class="meet">
                                <h3>Jacob</h3>
                                <p>Lorem ipsum dolor sit amet, iscing elit, sed do magna </p>
                    ...
                    <div class="col-md-4">
                        <div id="exp" class="experts_box">
                            <div class="experts_img">
                                <figure><img src="public/images/blog2.jpg" alt="#"/></figure>
                            </div>
                            <div class="meet">
                                <h3>Lonut</h3>
                                <p>Lorem ipsum dolor sit amet, iscing elit, sed do magna</p>
                    ...
                    <div class="col-md-4">
                        <div id="exp" class="experts_box">
                            <div class="experts_img">
                                <figure><img src="public/images/blog3.jpg" alt="#"/></figure>
                            </div>
                            <div class="meet">
                                <h3>Irina</h3>
                                <p>Lorem ipsum dolor sit amet, iscing elit, sed do magna</p>
            ...
            <div class="col-md-12">
                <div class="map_main">
                    <div class="map-responsive">
                        <iframe src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0s1a7phLN0iaD6-UE7m4qP-z21pH0eSc&amp;q=Группа компаний Neti, Казань, Респ. Татарстан, Россия" width="600" height="386" frameborder="0" style="border:0; width: 100%;" allowfullscreen=""></iframe>
                    </div>
                </div>
            </div>
        </div>
